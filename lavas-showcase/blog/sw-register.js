if ('serviceWorker' in navigator) {
    ...
    const handlerUpdateMessage = e => {
        ...
        dom.innerHTML = '<div class="app-refresh" id="app-refresh" style="background:#000;color:#fff;height:0;line-height:0;opacity:0;position:fixed;left:0;right:0;z-index:10001;padding:0 18px;transition all:.2s ease-in;">'
